// задача n2
    ...
    functionDeclinationRus(1,[' дом',' дома',' домов']);
    functionDeclinationRus(2,[' дом',' дома',' домов']);
    functionDeclinationRus(5,[' дом',' дома',' домов']);
...
const fngenius = (title) =>{
    return title.toLowerCase()
}

console.log(fngenius('ARTEM'))
// // задание n4
